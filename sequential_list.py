...
class InterfaceGrafica:
    ...
    def __init__(self, master):
        ...
        self.label = Label(master, text="Lista Sequencial")
        self.label.pack()
    ...
    def atualizar_listbox(self):
        ...
        for i in range(len(self.lista_sequencial.lista)):
            caixa = Label(self.frame_lista, text=self.lista_sequencial.lista[i], width=4, borderwidth=1, relief="solid")
            caixa.pack(side=LEFT, padx=5)
